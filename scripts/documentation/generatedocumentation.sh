...
for filename in ${listofmissingfiles[@]}; do
   ...
   echo "" >> $outputfile
   echo "        # Your $containername workflow..." >> $outputfile
   echo "" >> $outputfile
   echo "  .. tab-item:: Bell, Gautschi, or Negishi" >> $outputfile
   echo "" >> $outputfile
   echo "    .. code-block:: bash" >> $outputfile
   echo "" >> $outputfile
   ...
   echo "        # Your $containername workflow..." >> $outputfile
   echo "" >> $outputfile
   echo "  .. tab-item:: Gautschi-AI" >> $outputfile
   echo "" >> $outputfile
   echo "    .. code-block:: bash" >> $outputfile
   echo "" >> $outputfile
   ...
   echo "        # Your $containername workflow..." >> $outputfile
   echo "" >> $outputfile
   echo "  .. tab-item:: Gilbreth" >> $outputfile
   echo "" >> $outputfile
   echo "    .. code-block:: bash" >> $outputfile
   echo "" >> $outputfile
